...
from multitenant_cms.settings.s3storage import PublicMediaS3BotoStorage
from easy_thumbnails.fields import ThumbnailerImageField
from django.dispatch import receiver
from django.db.models.signals import post_save
from multitenant_cms.thumbnailer.tasks import generate_thumbnails
...
class Image(Orderable):
    ...
    src = ThumbnailerImageField(_("Image file"), upload_to=get_media_path,
                            height_field='src_height',
                            thumbnail_storage=PublicMediaS3BotoStorage(),
